            ...
            <div class="app-users-warp scroll">
              <div @mousedown.stop>
                ...
                >
                  <template
                    slot="time"
                    v-if="finallyMessage(item.id).time"
                  >{{ finallyMessage(item.id).time | friendlyTime }}</template>
                </UserItem>
              </div>
            </div>
          </div>
          <div class="app-session-panel">
            <UiSessionPanel :session="curSession" @sendMessage="sendMessage" v-if="curSession.id">
              <template slot="info">
